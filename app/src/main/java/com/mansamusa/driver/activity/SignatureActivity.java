    ...
    Button.OnClickListener onButtonClick = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v == mClear) {
                ...
                mSignature.clear();
                mGetSign.setEnabled(false);
                mClear.setTextColor(getResources().getColor(R.color.white));
                mGetSign.setTextColor(getResources().getColor(R.color.white));
            } else if (v == mGetSign) {
...
//                setResult(Activity.RESULT_CANCELED, returnIntent);
    ...
    public class signature extends View {
        ...
        private static final float HALF_STROKE_WIDTH = STROKE_WIDTH / 4;
        ...
        public void save(View v, String StoredPath) {
            ...
            try {
               ...
               /* Intent intent = new Intent(SignatureActivity.this, Registeration.class);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    mGetSign.setTextColor(getResources().getColor(R.color.colorBrown));
                    mClear.setTextColor(getResources().getColor(R.color.colorBrown));
                    break;
